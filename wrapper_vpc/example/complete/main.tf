    ...
    "ipv4" = {
      ...
      subnets = {
        "private" = {
          "01" = {
            ...
            az          = "a"
            route_table = "private-01"
            network_acl = "private-01"
          ...
          "02" = {
            ...
            az          = "b"
            route_table = "private-02"
            network_acl = "private-02"
          }
        }
        "public" = {
          "01" = {
      ...
      endpoints = {
        "00" = {
          ...
          route_table_ids = ["private-01", "private-02"]
          policy          = data.aws_iam_policy_document.s3_endpoint_policy.json
        },
        "01" = {
          service         = "dynamodb"
          service_type    = "Gateway"
          route_table_ids = ["private-01", "public"]
