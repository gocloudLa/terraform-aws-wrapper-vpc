    ...
    vpn = {
      "vpn-01" = {
        ...
        vpn_connection = {
          ...
          tunnel1_preshared_key = local.secrets.vpn_preshared_key //si la pre-shared-key la define un cliente se puede usar parameter store
          ...
          tunnel2_preshared_key = local.secrets.vpn_preshared_key
